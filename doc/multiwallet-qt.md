...
Only requiring some minor changes is atl.cpp.
...
Changes to atl.cpp
----------------------
atl.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
