    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("ATL-light"), QVariant("light"));
    ui->theme->addItem(QString("ATL-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("ATL-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("ATL-traditional"), QVariant("trad"));
