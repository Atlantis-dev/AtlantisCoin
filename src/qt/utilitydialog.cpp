    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Atl Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Atl Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  atl-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Atl in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.1 ATL, 1 ATL, 10 ATL, and 100 ATL--sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://atlpay.atlassian.net/wiki/display/DOC/PrivateSend\">https://atlpay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Atl Core is shutting down...") + "<br /><br />" +
