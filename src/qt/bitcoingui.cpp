    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Atl Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Atl address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and atl: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Atl Core"), this);
    aboutAction->setStatusTip(tr("Show information about Atl Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Atl Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Atl addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Atl addresses"));
    ...
    openAction->setStatusTip(tr("Open a atl: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Atl Core help message to get a list with possible Atl Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Atl Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Atl network", "", count));
}
...
{
    QString strTitle = tr("Atl Core"); // default title
