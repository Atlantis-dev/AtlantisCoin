 ...
 *
 *   // network
 *   CAtlNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.atl.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CAtlNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
// // can be under: AtlNetwork
// //   -- signature requirements : Key1(User)
// class CAtlNetworkVariable : public CGovernanceObject
// {
// private:
